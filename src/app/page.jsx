    ...
    <main className="flex min-h-screen flex-col items-center justify-center gap-10 bg-[url(../assets/bg-stars.svg)] bg-cover pb-[20px] pt-[100px]">
      ...
      <div className="z-9 flex w-full flex-wrap items-center justify-evenly gap-10">
        <section className="flex w-[400px] flex-col items-center justify-center">
          <h1 className="text-2xl font-bold text-pink-500">Elisa Rosal</h1>
          ...
          <div className="flex w-[100%] justify-center gap-2 pt-2">
            <Link href="/sobre">
              <button className="text-md flex h-[30px] w-[100px] items-center justify-center rounded-full bg-pink-500  text-white hover:bg-pink-300">
                Saiba Mais
              </button>
            </Link>
        ...
        <div className=" z-10 flex h-[225px] w-[200px] items-center justify-center overflow-hidden rounded-bl-[55%] rounded-br-[35%] rounded-tl-[50%]  rounded-tr-[70%] border-[1px] border-solid border-pink-500 hover:bg-gray-400 dark:hover:bg-black ">
          <Image src={elisa} alt="" width={200} height={300} className="" />
        </div>
      </div>

      <h1 className="text-2xl font-black  text-pink-500">Meus serviços</h1>

      <Services />

      <section className="flex w-full flex-col items-center gap-3 font-black">
        <h1 className="animate-slidemov text-2xl text-pink-500 ">
          Entre em contato
        </h1>

        <Link href="/contato" className="animate-slidemov ">
